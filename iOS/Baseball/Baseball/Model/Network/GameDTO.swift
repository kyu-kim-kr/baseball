...
struct GameDTO: Decodable {
    private (set) var gameScoreDTO: GameScoreDTO
    private (set) var halfInningGameDTO: GameInformationDTO
    private (set) var pitcherDTO: PlayerDTO
    private (set) var hitterDTO: PlayerDTO
    private (set) var ballCountDTOs: [BallCount]
}
...
extension GameDTO {
    func toDomain() -> Game {
        return .init(id: halfInningGameDTO.id,
                     ...
                     inningStatus: halfInningGameDTO.inningStatus,
                     hitter: hitterDTO.toDomain(),
